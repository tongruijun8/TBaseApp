 ...
 * 创建时间：2019/8/6 15:47
 */
public class RvMoreAdapter2 extends TRecyclerMoreItemAdapter2 {

    public RvMoreAdapter2(int code) {
        this(code,null);
    }

    public RvMoreAdapter2(int code, @Nullable List<Object> data) {
        super(code, data);
        if(code == 1){
