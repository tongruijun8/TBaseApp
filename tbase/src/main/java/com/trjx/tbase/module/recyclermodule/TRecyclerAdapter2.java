 ...
 */
public abstract class TRecyclerAdapter2 extends BaseQuickAdapter<Object, BaseViewHolder> {

    //区别码
    public int code;

    public TRecyclerAdapter2(int code) {
        this(code, null);
    }

    @Override
    protected abstract void convert(BaseViewHolder helper, Object item);

    public TRecyclerAdapter2(int code, @Nullable List<Object> data) {
        super(data);
        this.code = code;
